...
export interface ApiCollegeCollege extends Schema.CollectionType {
  ...
  attributes: {
    ...
    coursesOffered: Attribute.JSON & Attribute.Required;
    numberOfStudents: Attribute.Integer & Attribute.Required;
    rating: Attribute.Decimal;
    yearFounded: Attribute.Date;
    collegeId: Attribute.UID & Attribute.Required;
...
export interface ApiStudentStudent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    studentId: Attribute.UID & Attribute.Required;
    ...
    collegeId: Attribute.String & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
